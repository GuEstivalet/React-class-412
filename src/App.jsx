...
const perguntas = [
  ...
  {
    pergunta: 'Qual método utilizado para criar componentes?',
    options: ['React.makeComponent()','React.createComponent()','React.createElement()'],
    resposta: 'React.createElement()',
    id: 'p1',
  },
  {
    pergunta: 'Como importamos componente externo?',
...
const App = () => {
  ...
  function resultadoFinal(){
    ...
    setResultado(`Você acertou: ${corretas.length}/4`);
  }
  ...
  return (
    <form onSubmit={(event) => event.preventDefault()}>
      ...
      <Radio active={slide === index} value={respostas[pergunta.id]} key={pergunta.id} onChange={handleChange} {...pergunta} /> )}
